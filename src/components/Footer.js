...
<footer className="p-4 sm:p-6 bg-purple-900">
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <Link href="" className="flex items-center">
                <img src={logo} className="mr-3 h-8 f-logo" alt="FlowBite Logo" />
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Photo-Phactory</span>
            </Link>
        </div>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <Link to='/home' className="hover:underline">Photo-Phactory™</Link>. All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <Link href="#" className="text-gray-300 hover:text-gray-900 dark:hover:text-white">
